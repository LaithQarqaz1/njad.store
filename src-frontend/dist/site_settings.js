(function (global) {
  ...
  var defaultSettings = {
    ...
    "brand": {
        ...
        "storeNameAr": "نجاد ستور",
        "storeShortName": "Njad"
    },
    "seo": {
        "title": "Njad store | نجاد ستور",
        "description": "Njad store | نجاد ستور للخدمات الرقمية وشحن الألعاب والاشتراكات بسرعة وأمان، مع تسجيل دخول ودعم مباشر.",
        "shortDescription": "Njad store | نجاد ستور للخدمات الرقمية وشحن الألعاب والاشتراكات بسرعة وأمان.",
        "siteOrigin": "https://njad.store"
    },
    "security": {
    ...
    "media": {
        "siteIcon": "",
        "sitePreview": "",
        "imagesOrigin": "https://img.njad.store"
    },
    "pwa": {
        "legacyCachePrefixes": [
            "njadstore1-pwa-",
